        ...
        <div class="card-body">
            ...
            <div class="row">
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <!-- app_hotline Field -->
                    <div class="form-group row">
                        {!! Form::label('app_hotline', trans("lang.app_setting_app_hotline"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('app_hotline', setting('app_hotline'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_app_hotline")]) !!}
                        
                        </div>
                    </div>
                    <!-- facebook Field -->
                    <div class="form-group row">
                        {!! Form::label('facebook', trans("lang.app_setting_facebook"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('facebook', setting('facebook'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_facebook")]) !!}
                        
                        </div>
                    </div>
                    <!-- whatsapp Field -->
                    <div class="form-group row">
                        {!! Form::label('whatsapp', trans("lang.app_setting_whatsapp"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('whatsapp', setting('whatsapp'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_whatsapp")]) !!}
                        
                        </div>
                    </div>
                    <!-- instgram Field -->
                    <div class="form-group row">
                        {!! Form::label('instgram', trans("lang.app_setting_instgram"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('instgram', setting('instgram'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_instgram")]) !!}
                        
                        </div>
                    </div>
                    <!-- app_store Field -->
                    <div class="form-group row">
                        {!! Form::label('app_store', trans("lang.app_setting_app_store"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('app_store', setting('app_store'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_app_store")]) !!}
                        
                        </div>
                    </div>
                    <!-- google_play Field -->
                    <div class="form-group row">
                        {!! Form::label('google_play', trans("lang.app_setting_google_play"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('google_play', setting('google_play'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_google_play")]) !!}

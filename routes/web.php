...
Route::middleware('auth')->group(function () {
    ...
    Route::post('ads/remove-media', 'AdController@removeMedia'); 
...
Route::get('addbranches', 'FullDatabaseController@branches')->name('branches.add'); //adeed
Route::get('addCategory', 'FullDatabaseController@Category')->name('Category.Category'); //adeed
Route::get('addproduct', 'FullDatabaseController@product')->name('product.product'); //adeed
